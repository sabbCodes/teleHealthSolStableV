...
import { ArrowRight, ArrowLeft, Pill, Building, Mail, CheckCircle, Shield, Clock, AlertCircle } from "lucide-react"
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              ...
              link to verify your pharmacy account.
            </p>
      ...
      <header className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Pharmacy Registration</span>
          </div>
        </div>
      </header>
              ...
              {currentStep === 1 && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Pharmacy Information</h2>
                    <p className="text-gray-600 dark:text-gray-300">Let's start with your pharmacy's basic details</p>
                  </div>
              ...
              {currentStep === 2 && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">License & Registration</h2>
                    <p className="text-gray-600 dark:text-gray-300">Verify your pharmacy's credentials</p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <Label htmlFor="minimumOrderValue">Minimum Order (USDC)</Label>
                      <Input
              ...
              {currentStep === 3 && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Services & Operations</h2>
                    <p className="text-gray-600 dark:text-gray-300">Configure your services and operating hours</p>
                  </div>
                      ...
                      {Object.entries(formData.services).map(([service, enabled]) => (
                        <div key={service} className="flex items-center space-x-2">
                          <Checkbox
                            id={service}
                            checked={enabled}
                            onCheckedChange={(checked) => updateNestedFormData("services", service, checked)}
                          />
                          <Label htmlFor={service} className="capitalize">
                            {service === "otc" ? "Over-the-Counter Medications" : service.replace(/([A-Z])/g, " $1")}
                          </Label>
                        </div>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="usdc" className="font-medium text-green-600">
                          USDC (Required)
                        </Label>
                      </div>
                        ...
                        .map(([method, enabled]) => (
                          <div key={method} className="flex items-center space-x-2">
                            <Checkbox
                              id={method}
                              checked={enabled}
                              onCheckedChange={(checked) => updateNestedFormData("paymentMethods", method, checked)}
                            />
                            <Label htmlFor={method} className="capitalize">
                              {method === "creditCard" ? "Credit/Debit Card" : method.replace(/([A-Z])/g, " $1")}
                            </Label>
                          </div>
                        ))}
                    </div>
                  ...
                  <div>
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      />
                      <Label htmlFor="acceptsInsurance" className="text-base font-semibold">
                        Accept Insurance
                      </Label>
                    </div>
                          ...
                          <div key={provider} className="flex items-center space-x-2">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                if (checked) {
                                  updateFormData("insuranceProviders", [...formData.insuranceProviders, provider])
                                } else {
                                  updateFormData(
                                    "insuranceProviders",
                                    formData.insuranceProviders.filter((p) => p !== provider),
                                  )
                                }
                              }}
                            />
              ...
              {currentStep === 4 && (
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Operating Hours</h2>
                    <p className="text-gray-600 dark:text-gray-300">Set your pharmacy's operating schedule</p>
                  </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    <h3 className="font-semibold text-blue-900 dark:text-blue-300 mb-2">Review Your Information</h3>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                    <h3 className="font-semibold text-green-900 dark:text-green-300 mb-2">USDC Payments Ready</h3>
