            ...
            >
              <div className="relative z-10">
                <img
                  ...
                  className="w-full h-auto max-w-lg mx-auto bg-transparent"
                />
              </div>
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    We're bridging the healthcare gap in developing nations by
                    connecting patients with world-class doctors through
                    blockchain technology.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">teleHealthSol</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 teleHealthSol. All rights reserved.
            </p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  ...
                  />
                  <path
                    d="M6.5 15.5L8.5 13.5L6.5 11.5L8.5 9.5L10.5 11.5L12.5 9.5L14.5 11.5L12.5 13.5L14.5 15.5L12.5 17.5L10.5 15.5L8.5 17.5L6.5 15.5Z"
                    fill="white"
                  />
                  <defs>
                    <linearGradient
